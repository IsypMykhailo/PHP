...
class MailController
{
    ...
    public function sendMail(){
        ...
        try {
            ...
            $mail->Username   = 'amazonkanameforme@gmail.com';                     //SMTP username
            $mail->Password   = 'tprhdpvcvfnwzfew';                               //SMTP password
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
            $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

            //Recipients
            $mail->setFrom('amazonkanameforme@gmail.com', 'Mailer');
            $mail->addAddress('mikeisisyp@gmail.com', 'Joe User');     //Add a recipient
