...
@section('content')
    ...
    <section class="blog-single-hero set-bg" data-setbg="{{asset('img/blog-single-hero.jpg')}}">
        <div class="container">
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <img src="{{asset('img/blog-single-4.jpg')}}" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="blog-single-sidebar">
                        <div class="bs-latest-news">
                            <h4>News Latest</h4>
                            <a href="#" class="bl-item set-bg" data-setbg="{{asset('img/sidebar-latest.jpg')}}">
                        ...
                        <div class="bs-recent-news">
                            ...
                            <a href="#" class="br-item">
                                <div class="bi-pic">
                                    <img src="{{asset('img/br-recent-1.jpg')}}" alt="">
                                </div>
                                <div class="bi-text">
                            ...
                            <a href="#" class="br-item">
                                <div class="bi-pic">
                                    <img src="{{asset('img/br-recent-2.jpg')}}" alt="">
                                </div>
                                <div class="bi-text">
                                    <span>Jan 31, 2019</span>
                            ...
                            <a href="#" class="br-item">
                                <div class="bi-pic">
                                    <img src="{{asset('img/br-recent-3.jpg')}}" alt="">
                                </div>
                                <div class="bi-text">
                                    <span>Jan 31, 2019</span>
                            ...
                            <a href="#" class="br-item">
                                <div class="bi-pic">
                                    <img src="{{asset('img/br-recent-4.jpg')}}" alt="">
                                </div>
                                <div class="bi-text">
                                    <span>Jan 31, 2019</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="recent-news">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="recent-item set-bg" data-setbg="{{asset('img/recent-1.jpg')}}">
                            ...
                            <div class="col-lg-4">
                                <div class="recent-item set-bg" data-setbg="{{asset('img/recent-2.jpg')}}">
                                    <a href="#" class="recent-text">
                                        <div class="categories">Gym & Croosfit</div>
                                        <h5>Many people sign up for affiliate programs</h5>
                                    </a>
                            ...
                            <div class="col-lg-4">
                                <div class="recent-item set-bg" data-setbg="{{asset('img/recent-3.jpg')}}">
                                    <a href="#" class="recent-text">
                                        <div class="categories">Gym & Croosfit</div>
                                        <h5>Many people sign up for affiliate programs</h5>
                                    </a>
