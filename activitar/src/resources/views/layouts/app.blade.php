                    ...
                    <div class="nav-menu">
                        <nav class="mainmenu mobile-menu">
                            <ul id="elContainer">
                                ...
                                <li class="item"><a href="{{url('/schedule')}}">Schedule</a></li>
                                <li class="item"><a href="{{url('/gallery')}}">Gallery</a></li>
                                <li class="item"><a href="{{url('/blog')}}">Blog</a>
                                    <ul class="dropdown">
                                        <li><a href="{{url('/about')}}">About Us</a></li>
                                        <li><a href="{{url('/blog-single')}}">Blog Details</a></li>
                                    </ul>
                                </li>
                                <li class="item"><a href="{{url('/contact')}}">Contacts</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
